...
# ---
	...
	#####Raja Edit For LDAP Customer Information#############
	...
	$Param{UserDepartment} = $CustomerData{UserDepartment};
	$LayoutObject->Block(
            Name => 'UserDepartment',
           Data => { %Param, %AclAction },
    );
	...
	$Param{UserLOB} = $CustomerData{UserLOB};
	$LayoutObject->Block(
            Name => 'UserLOB',
           Data => { %Param, %AclAction },
    );
	...
	$Param{UserSiteId} = $CustomerData{UserSiteId};
	$LayoutObject->Block(
            Name => 'UserSiteId',
           Data => { %Param, %AclAction },
    );
	...
	$Param{UserManager} = $CustomerData{UserManager};
	$LayoutObject->Block(
            Name => 'UserManager',
           Data => { %Param, %AclAction },
    );
	...
	#####Eo Raja Edit For LDAP Customer Information#############
